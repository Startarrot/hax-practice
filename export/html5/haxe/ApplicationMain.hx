...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("hax-practice", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("hax-practice", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "hax-practice";
		app.meta["name"] = "hax-practice";
